        ...
        '>
            ...
            <div className="overflow-hidden h-full relative">
                <p className="whitespace-normal break-words overflow-hidden text-ellipsis line-clamp-6">
                    {props.body}
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptate repudiandae nemo nostrum deserunt molestiae ab dicta sequi inventore dolorem autem accusantium odit a iusto eos laborum quia perspiciatis voluptatem quos iste modi, quis, culpa maxime? Nesciunt quas deserunt illum harum aspernatur fugiat eos, quia cum minima cupiditate, inventore maiores autem.
                </p>
